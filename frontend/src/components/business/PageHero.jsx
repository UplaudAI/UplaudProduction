...
function NorthStarBlock({ data, nav }) {
  ...
  return (
    <div
      ...
      className="h-full flex flex-col rounded-2xl border border-[#eeeaf6] bg-white p-6 md:p-7"
    >
      <div className="text-[11px] font-mono uppercase tracking-[0.18em] text-[#9ca3af]">
        {data.label}
      </div>
      <div className="mt-3 flex items-baseline gap-3 flex-wrap">
        ...
        {data.delta && (
          <div className={`inline-flex items-center gap-1.5 text-[12.5px] font-mono ${trendColor}`}>
