        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="hidden sm:flex items-center gap-3 sm:ml-auto">
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-md p-2 bg-transparent hover:bg-transparent focus:bg-transparent border-0 shadow-none hover:opacity-70 transition-opacity"
